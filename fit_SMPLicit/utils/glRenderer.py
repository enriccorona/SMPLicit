...
from .shaders.framework import createProgram, loadShader

from .render_utils import ComputeNormal
...
class glRenderer:
    ...
    def setSideView(self):
        ...
        self.m_yRotate = 0 
        # NOTE: ANGLE ROTATION FOR SIDE VIEW:
        self.m_xRotate = 80 #+ self.counter
    ...
    def add_mesh(self, input_vertices, input_faces, normals=None, color=None):
        """
